                ...
                <div className="z-20 relative container mx-auto px-4">
                    <div className="block lg:flex md:flex-row-reverse items-center">
                        <div className="lg:w-3/6 p-4 z-20 lg:pb-24 lg:pt-12">
                            <div className="text-lg text-center lg:text-right md:text-2xl text-zinc-700">
                                ...
                                <Link href={ContentLinks.whatsapp} className="conversion-contact" target="_blank"><button className="transition text-orange-500 border-b-2 lg:border-b-0 lg:border-r-4 border-orange-500 font-medium  my-4 py-2 lg:py-1 px-6 text-base md:text-lg uppercase">FALAR COM UM CONSULTOR</button></Link>
                            </div>
                        </div>
                        <div className="lg:w-3/6 flex justify-content items-center pt-4 z-10">
