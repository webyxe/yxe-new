...
export default function Banner() {
    return (
        <>
            <div id="topo" className="bg-cover bg-landing bg-center min-h-[42rem] md:h-[32rem] lg:h-[35rem] 2xl:h-[42rem] py-4">
                <div className="container mx-auto px-4 h-full">
                    <div className="md:flex items-center justify-center gap-x-16 h-full pt-20">
                        <div className="w-full md:w-1/2 h-full flex flex-col justify-center px-6 md:px-0 py-10 md:py-2">
                            ...
                            <Link href={ContentLinks.whatsapp} className="conversion-contact" target="_blank"><button type="button" className="block bg-orange-500 hover:bg-zinc-100 transition text-white font-medium rounded-md my-2 py-3 px-8 text-base uppercase mx-auto md:mx-0">SAIBA MAIS</button></Link>
                        </div>
