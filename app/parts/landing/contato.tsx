                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4">
                        <div className="text-sm md:text-xl text-black rounded-xl text-center md:text-left">
                            <div className="text-md md:text-lg py-6 md:p-6 my-3 md:mt-0">
                                ...
                                <div className="text-lg lg:text-xl font-light pb-8">Não deixe sua mensagem se perder no ruído político. Com o Group YXE, você terá a <span className="font-medium">vantagem competitiva</span> necessária para se <span className="font-medium">destacar</span>. Entre em contato conosco hoje mesmo e descubra como podemos <span className="font-medium">transformar sua visão política em realidade</span>.</div>
                                <div>
                                    <Link className="block" href={ContentLinks.whatsapp}><button type="button" className="mx-auto md:mx-0 py-2 px-6 text-base rounded-md bg-orange-500 hover:bg-orange-600 transition ease-in-out duration-300 delay-300 text-white uppercase flex justify-center items-center gap-x-2"><FontAwesomeIcon icon={faArrowRight} />fale com um consultor</button></Link>
                                </div>
                            </div>
                        </div>
