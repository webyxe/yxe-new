...
export default function Call() {
    return (
        <section id="call" className="py-10 md:py-16 bg-call bg-cover bg-center bg-blue-600">
            <div className="container mx-auto px-4">
                <div className="block lg:flex">
                    ...
                    <div className="lg:w-5/12 flex flex-col justify-center items-center">
                        <Link href={ContentLinks.whatsapp} className="conversion-contact" target="_blank"><button type="button" className="bg-orange-500 hover:bg-orange-600 transition text-white font-medium rounded-full my-4 py-2 md:py-3 px-8 md:px-10 xl:px-16 block text-base md:text-lg mx-auto uppercase">entrar em contato</button></Link>
                    </div>
                </div>
            </div>
        </section>
