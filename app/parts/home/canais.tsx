                    ...
                    <div className="my-4 md:my-0">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                            <div className="p-4 md:p-8 flex justify-center items-center">
                                <Image src="/img/certificados/partner.png" width={200} height={160} className="w-full md:w-3/4" alt="" />
                            </div>
                            <div className="p-4 md:p-8 flex justify-center items-center">
                                <Image src="/img/certificados/meta.png" width={200} height={160} className="w-full md:w-3/4" alt="" />
                            </div>
                            <div className="p-4 md:p-8 flex justify-center items-center">
                                <Image src="/img/certificados/tiktok.png" width={200} height={160} className="w-full md:w-3/4" alt="" />
                            </div>
                            <div className="p-4 md:p-8 flex justify-center items-center">
                                <Image src="/img/certificados/cenp.png" width={200} height={160} className="w-full md:w-3/4" alt="" />
                            </div>
                            <div className="p-4 md:p-8 flex justify-center items-center">
                                <Image src="/img/certificados/ancine.png" width={200} height={160} className="w-full md:w-3/4" alt="" />
                            </div>
                            <div className="p-4 md:p-8 flex justify-center items-center">
                                <Image src="/img/certificados/fenapro.png" width={200} height={160} className="w-full md:w-3/4" alt="" />
                            </div>
                        </div>
                    </div>
